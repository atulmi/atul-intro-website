export const personal = {
  name: 'Atul Murali',
  title: 'Web Developer',
  tagline: 'Building user-friendly web apps with React, Vue, TypeScript, and Golang — across startups, nonprofits, and defense contractors.',
  ...
  story: 'My path into web development started in high school on a Chromebook. With most websites blocked, I found myself on w3schools.com teaching myself HTML, CSS, and JavaScript during free periods — what started as a way to kill time gradually turned into a genuine passion, and eventually a career.',
}

export const skills: { category: string; items: string[] }[] = [
  {
    category: 'Frontend',
    items: ['React', 'Vue', 'TypeScript', 'JavaScript', 'HTML/CSS', 'Redux', 'Bootstrap', 'MUI'],
  },
  {
    category: 'Backend',
  ...
  {
    category: 'Tools',
    items: ['Git', 'Vite', 'AgGrid', 'Tanstack Query', 'pdfmake', 'Claude Code'],
  },
]
